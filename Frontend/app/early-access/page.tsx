                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-5">
                      ...
                      <select
                        id="experience"
                        className="w-full bg-purple-400 bg-opacity-10 border border-violet-800/50 focus:border-violet-500 focus:ring-2 focus:ring-violet-500 rounded-lg px-4 py-3 text-white"
                        value={experience}
                      ...
                      >
                        <option
                          value=""
                          disabled
                          className="bg-white text-black focus:bg-purple-500 hover:bg-purple-500"
                        >
